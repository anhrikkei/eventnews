...
urlpatterns = [
    ...
    path('baiviet_export_csv/<str:search>', baiviet_ad.baiviet_view.export_csv, name="baiviet_export_csv"),
    path('baiviet_export_excel/<str:search>', baiviet_ad.baiviet_view.export_excel, name="baiviet_export_excel"),
